...
public abstract class ReaderTableObjectFromMultipleRows<T> extends ReaderTableObjectAbstract<T> {
	...
	public ReaderTableObjectFromMultipleRows(BufferedReader reader, boolean columnIds,
	...
	public ReaderTableObjectFromMultipleRows(File file, boolean columnIds, boolean rowIds,
	...
	public ReaderTableObjectFromMultipleRows(InputStream stream, boolean columnIds, boolean rowIds,
			String delim) throws IOException {
	...
	public ReaderTableObjectFromMultipleRows(Reader reader, boolean columnIds, boolean rowIds,
			String delim) throws IOException {
		super(reader, columnIds, rowIds, delim);
